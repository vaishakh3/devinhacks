...
Hero refresh: cream headline over a dark lower gradient, date-and-Register ticket, compact labelled desktop navigation, existing unified mobile menu retained. Register links point to the coming-soon section until event-config.js supplies the Luma URL. Verified desktop, 390px and 320px layouts; mobile menu opens/closes and Register anchors work; no 320px horizontal overflow; hero film reached its final frame without media error. JavaScript syntax and diff whitespace checks passed.
